    ...
    paypal.Buttons({
      ...
      onApprove: function onApprove(data, actions) {
        return actions.order.capture().then(function (orderData) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.post(url, { 'data': JSON.stringify(orderData) }, function (data, status) {
            if (data[0] == 'Success') {
...
var getTotal = function getTotal() {
  var total = 0.01;
  var url = window.location.href.replace('checkout', 'ordertotal');
  __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(url, function (data, status) {
